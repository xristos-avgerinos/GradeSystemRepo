...
namespace GradeSystem.Controllers
{
    public class CoursesController : Controller
    {
        ...
        {
            var dBContext = _context.Courses.Include(c => c.Professor);
        ...
        public async Task<IActionResult> Create([Bind("IdCourse,CourseTitle,CourseSemester,Afm")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdCourse,CourseTitle,CourseSemester,Afm")] Course course)
        {
